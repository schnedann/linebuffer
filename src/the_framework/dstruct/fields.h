...
template<typename I> constexpr bool is_in_bounds(field_fl<I> const ffl, field_fl<I> const bounds){
  bool in_bounds = true;
...
template<typename I> constexpr bool is_in_bounds(field_se<I> const fse, field_se<I> const bounds){
  return is_in_bounds<I>(make_field_fl<I>(fse),make_field_fl<I>(bounds));
}

template<typename I> constexpr bool is_in_bounds(field_sl<I> const fsl, field_sl<I> const bounds){
...
template<typename I> constexpr I get_lest(field_sl<I> const fsl){
  return make_field_fl<I>(fsl).last;
}

template<typename I> constexpr I get_lest(field_se<I> const fse){
  return make_field_fl<I>(fse).last;
}

template<typename I> constexpr I get_lest(field_fl<I> const ffl){
  return ffl.last;
}
